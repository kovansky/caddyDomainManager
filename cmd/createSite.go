...
func init() {
	...
	createSiteCmd.Flags().StringVarP(&dbAuthDatabase, "db-auth-db", "s", "", "Authentication database (only for mongo and postgres, default to username)")
